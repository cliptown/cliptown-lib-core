...
//
// SeaORM entity for cliptown.clip_embeddings. SeaORM is the application ORM for this fleet; direct
...
#[sea_orm(schema_name = "cliptown", table_name = "clip_embeddings")]
pub struct Model {
...
/// One registry entry, mirroring `cliptown.embedding_models`.
