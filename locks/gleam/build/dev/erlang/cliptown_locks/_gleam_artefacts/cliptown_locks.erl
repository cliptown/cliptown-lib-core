-module(cliptown_locks).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch, inline]).
-define(FILEPATH, "src/cliptown_locks.gleam").
...
?MODULEDOC(
    " cliptown lock routines: `ores_locks_and_leases` with the org's key prefix\n"
...
-file("src/cliptown_locks.gleam", 20).
...
-file("src/cliptown_locks.gleam", 47).
...
-file("src/cliptown_locks.gleam", 72).
...
-file("src/cliptown_locks.gleam", 113).
...
-file("src/cliptown_locks.gleam", 118).
