...
Lock routines for **cliptown**, wrapping
...
| Path | Package |
| --- | --- |
| `rust` | `cliptown-locks` crate |
| `typescript` | `@cliptown/locks` |
| `dart` | `cliptown_locks` |
| `gleam` | `cliptown_locks` |
| `golang` | `github.com/cliptown/cliptown-lib-core/locks/golang` |

Every key this org locks is `cliptown/<domain>/<name>`; the prefix is applied
