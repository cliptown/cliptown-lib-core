...
check was introduced: **16 findings across 7 files
and 1,091 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `RS001` | 14 | warn | immutable values | mutable local binding (`let mut`) |
...
*immutable values* · 14 occurrences at baseline
