...
check was introduced: **11 findings across 7 files
and 1,170 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `RS001` | 8 | warn | immutable values | mutable local binding (`let mut`) |
...
*immutable values* · 8 occurrences at baseline
